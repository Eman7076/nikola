  ...
  outputs =
    ...
    in
    {
      ...
      checks.${system} = {
        ...
        # D6.2: one-bell external bus watcher (script+eval always; nixosTest may need Court rig virt).
        d6-one-bell-script = import ./d6/one-bell/check-watch-script.nix { inherit pkgs; };
