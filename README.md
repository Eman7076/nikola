...
| **D6.2** | Revised 2026-09-25 (module + checks) | [`d6/02-one-bell.md`](./d6/02-one-bell.md) + [`d6/one-bell/`](./d6/one-bell/) external bus heartbeat watcher on **controller** (watcher-of-watcher); no `Persistent=true` |
